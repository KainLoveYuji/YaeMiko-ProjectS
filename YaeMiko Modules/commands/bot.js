...
module.exports.onLoad = function() {
 ...
 console.log(chalk.bold.hex("# 00FF00").bold("======== [ START LOADING INFO PROJECT ] ========"));
...
url: (await global.nodemodule["axios"]('https://api-kainriyu-project-yv9i.onrender.com/vdanimev2')).data.data,
method: "GET",
responseType: "stream"
})).data
...
❎ 𝐓𝐮𝐨̂̉𝐢: 29
👤 𝐆𝐢𝐨̛́𝐢 𝐓𝐢́𝐧𝐡: Nam/Nữ
💫 𝐂𝐡𝐢𝐞̂̀𝐮 𝐜𝐚𝐨 𝐜𝐚̂𝐧 𝐧𝐚̣̆𝐧𝐠: 1m9/80kg
💘 𝐌𝐨̂́𝐢 𝐪𝐮𝐚𝐧 𝐡𝐞̣̂: Vợ Mei Sumire
🌎 𝐐𝐮𝐞̂ 𝐪𝐮𝐚́𝐧: ...
👫 𝐆𝐮: ...
🌸 𝐓𝐢́𝐧𝐡 𝐜𝐚́𝐜𝐡: Lúc Nhây Lúc Thất Thường
🌀 𝐒𝐨̛̉ 𝐭𝐡𝐢́𝐜𝐡: Yêu Vợ, Ăn Cơm Vợ Nấu
💻 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 💻
☎ 𝗦𝗗𝗧 & 𝗭𝗮𝗹𝗼: ...
🌐 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤: Fb//KainFoxy.1911`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100042072160633}/picture?height=720&width=720&access_token=1073911769817594|aa417da57f9e260d1ac1ec4530b417de`)).pipe(
...
return api.sendMessage("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐫𝐞𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐧𝐟𝐢𝐠.𝐣𝐬𝐨𝐧", event.threadID, event.messageID);    
          ...
          /// admin only ///
        case "5": {
          if (event.senderID != 100042072160633) return api.sendMessage(`» 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
