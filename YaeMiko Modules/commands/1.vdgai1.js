...
if (event.reaction != "🌿") return;
 api.unsendMessage(handleReaction.messageID);
    var msg =`『 🍓 』𝐕𝐃 𝐆𝐀́𝐈『 🍓 』\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n『 💮 』 ➣ 𝐂𝐡𝐚̀𝐨 ${global.data.userName.get(event.senderID)} 𝐂𝐡𝐮́𝐜 𝐁𝐚̣𝐧 𝟏 𝐍𝐠𝐚̀𝐲 𝐕𝐮𝐢 𝐕𝐞̉ \n『 ⚘️ 』 ➣ 𝐕𝐢𝐝𝐞𝐨 𝐂𝐮̉𝐚 𝐁𝐚̣𝐧 𝐍𝐞̀ \n『 💬 』 ➣ 𝐓𝐡𝐢́𝐧𝐡: 『 ${thơ} 』\n『 🧸 』 ➣ 𝐇𝐨̂𝐦 𝐍𝐚𝐲 𝐋𝐚̀ ${thu}\n『 𝐀𝐡𝐫𝐢 𝐇𝐮𝐲𝐞̂̀𝐧 𝐓𝐡𝐨𝐚̣𝐢 𝐁𝐚̂́𝐭 𝐓𝐮̛̉ 』\n『 ${gio} || ${ngay} 』`
    return api.sendMessage({body: msg, attachment: (await axios.get((await axios.get(`https://api-kainriyu-project.onrender.com/vdgirl`)).data.data,  {
                    responseType: 'stream'
                })).data},event.threadID); 
    }
