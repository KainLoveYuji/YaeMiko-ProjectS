...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "boxahri.jpg")) request("https://i.imgur.com/zEamAcw.jpg").pipe(fs.createWriteStream(dirMaterial + "boxahri.jpg"));
}
