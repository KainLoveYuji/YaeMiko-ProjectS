...
module.exports.handleEvent = async function ({ api, event, Threads }) {
  ...
  const allicon = ["💞","💖","💗","💜","🌸","💗","💝","🎀","🌹","🍁","🎊","🌟","🐾","🪷","🌿","☘️","🍀","🍓","🍰","🔮","🍒"];
const randomicon = allicon[Math.floor(Math.random()*allicon.length)];
...
bt = Math.floor(time % 60);
 var { threadID, messageID, body } = event,{ PREFIX } = global.config;
  ...
  const icon = [""];
  if (body.toLowerCase() == "prefix" || (body.toLowerCase() == "prefix bot là gì") ||  (body.toLowerCase() == "quên prefix") || (body.toLowerCase() == "prefix bot")) {
       api.sendMessage({body: `『 🍓 』𝐏𝐑𝐄𝐅𝐈𝐗『 🍓 』\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n『 🌿 』 ➣ 𝐏𝐫𝐞𝐟𝐢𝐱 𝐂𝐮̉𝐚 𝐁𝐨𝐱 𝐋𝐚̀: ${prefix}\n『 ❗️ 』 ➣ 𝐏𝐫𝐞𝐟𝐢𝐱 𝐂𝐮̉𝐚 𝐇𝐞̣̂ 𝐓𝐡𝐨̂́𝐧𝐠 𝐋𝐚̀: ${global.config.PREFIX}\n『 💝 』 ➣ 𝐇𝐢𝐞̣̂𝐧 𝐓𝐚̣𝐢 𝐁𝐨𝐭 𝐂𝐨́ ${client.commands.size} 𝐋𝐞̣̂𝐧𝐡\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n『 💫 』 ➣ 𝐓𝐨̂̉𝐧𝐠 𝐍𝐠𝐮̛𝐨̛̀𝐢 𝐃𝐮̀𝐧𝐠 𝐁𝐨𝐭: ${global.data.allUserID.length}\n『 📒 』 ➣ 𝐓𝐨̂̉𝐧𝐠 𝐍𝐡𝐨́𝐦: ${global.data.allThreadID.length}\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n『 🧸 』 ➣ 𝐇𝐨̂𝐦 𝐍𝐚𝐲 𝐋𝐚̀ ${thu}\n『 ⏰ 』 ➣ 𝐍𝐠𝐚̀𝐲: ${ngay}\n◆━━━◆『 ${randomicon} 』◆━━━◆\n『 💬 』 ➣ 𝐓𝐡𝐢́𝐧𝐡: 『 ${thơ} 』\n『 𝐀𝐡𝐫𝐢 𝐂𝐡𝐢𝐞̂𝐮 𝐇𝐨̂̀𝐧 𝐓𝐡𝐢𝐞̂𝐧 𝐇𝐨̂̀ 』\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n『 ⚙️ 』 ➣ 𝐓𝐢̀𝐧𝐡 𝐓𝐫𝐚̣𝐧𝐠 𝐇𝐞̣̂ 𝐓𝐡𝐨̂́𝐧𝐠: 𝐓𝐨̂́𝐭🌿\n『 ⏳ 』 ➣ 𝐁𝐨𝐭 𝐎𝐧𝐥𝐢𝐧𝐞 : ${ahri} 𝐆𝐢𝐨̛̀ ${ht} 𝐏𝐡𝐮́𝐭 ${bt} 𝐆𝐢𝐚̂𝐲 🧸\n『 𝐌𝐲 𝐋𝐨𝐯𝐞 𝐘𝐚𝐞 𝐌𝐢𝐤𝐨 』\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n『 ${timeNow} 』\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n『 𝐀𝐡𝐫𝐢 𝐇𝐮𝐲𝐞̂̀𝐧 𝐓𝐡𝐨𝐚̣𝐢 𝐁𝐚̂́𝐭 𝐓𝐮̛̉ 』\n\n『 🍊 』 ➣ 𝐓𝐡𝐚̉ 𝐈𝐜𝐨𝐧 "🐾" 𝐕𝐚̀𝐨 𝐓𝐢𝐧 𝐍𝐡𝐚̆́𝐧 𝐍𝐚̀𝐲, 𝐁𝐚̣𝐧 𝐒𝐞̃ 𝐁𝐢𝐞̂́𝐭 𝐂𝐚́𝐜 𝐋𝐞̣̂𝐧𝐡 𝐓𝐡𝐮̛𝐨̛̀𝐧𝐠 𝐃𝐮̀𝐧𝐠`, attachment: (await axios.get((await axios.get(`https://api-kainriyu-project-yv9i.onrender.com/Images/animevip2`)).data.data, {
                    responseType: 'stream'
...
━━━━━━━━━━━━━━━━━━`
        return api.sendMessage({body: msg, attachment: (await axios.get((await axios.get(`https://api-kainriyu-project-yv9i.onrender.com/anime`)).data.data,  {
                    responseType: 'stream'
                })).data},event.threadID); 
    }
